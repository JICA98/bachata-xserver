...
Java_org_bachatas4_xserver_renderer_GPUImage_createHardwareBuffer(JNIEnv *env, jclass obj, jshort width,
...
JNIEXPORT jlong JNICALL
Java_org_bachatas4_xserver_renderer_GPUImage_createImageKHR(JNIEnv *env, jclass obj,
                                                   jlong hardwareBufferPtr, jint textureId) {
    return (jlong)createImageKHR((AHardwareBuffer*)hardwareBufferPtr, textureId);
}

JNIEXPORT void JNICALL
Java_org_bachatas4_xserver_renderer_GPUImage_destroyHardwareBuffer(JNIEnv *env, jclass obj,
...
Java_org_bachatas4_xserver_renderer_GPUImage_lockHardwareBuffer(JNIEnv *env, jclass obj,
...
JNIEXPORT void JNICALL
Java_org_bachatas4_xserver_renderer_GPUImage_unlockHardwareBuffer(JNIEnv *env, jclass obj,
                                                          jlong hardwareBufferPtr) {
    (void)env;
    (void)obj;
    AHardwareBuffer* hardwareBuffer = (AHardwareBuffer*)hardwareBufferPtr;
...
JNIEXPORT void JNICALL
Java_org_bachatas4_xserver_renderer_GPUImage_destroyImageKHR(JNIEnv *env, jclass obj, jlong imageKHRPtr) {
