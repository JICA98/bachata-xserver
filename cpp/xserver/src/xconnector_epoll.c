...
Java_org_bachatas4_xserver_xconnector_XConnectorEpoll_closeFd(jint fd) {
    CLOSEFD(fd);
}

JNIEXPORT jlong JNICALL
Java_org_bachatas4_xserver_xconnector_XConnectorEpoll_nativeAllocate(JNIEnv* env, jobject obj,
                                                            jstring sockPath) {
...
JNIEXPORT void JNICALL
Java_org_bachatas4_xserver_xconnector_XConnectorEpoll_destroy(JNIEnv *env, jobject obj, jlong nativePtr) {
    XConnectorEpoll_destroy(env, (XConnectorEpoll*)nativePtr);
}

JNIEXPORT void JNICALL
Java_org_bachatas4_xserver_xconnector_XConnectorEpoll_startEpollThread(JNIEnv *env, jobject obj,
...
JNIEXPORT void JNICALL
Java_org_bachatas4_xserver_xconnector_XConnectorEpoll_stopEpollThread(JNIEnv *env, jobject obj,
                                                             jlong nativePtr) {
    XConnectorEpoll_stopEpollThread((XConnectorEpoll*)nativePtr);
}

JNIEXPORT void JNICALL
Java_org_bachatas4_xserver_xconnector_XConnectorEpoll_killConnection(JNIEnv *env, jclass obj,
