package org.bachatas4.xserver.alsaserver;
    ...
    public boolean handleRequest(ConnectedClient client) throws IOException {
        ...
        switch (requestCode) {
            ...
            case RequestCodes.PREPARE:
                ...
                // Bachata native AudioTransport is socket-payload only (no SHM map).
                // Honor per-session Options.useSharedMemory — EmulationService sets false.
                // Static USE_SHARED_MEMORY alone forced SHM → AudioTrack wrote zeros.
                if (alsaClient.options.useSharedMemory) {
